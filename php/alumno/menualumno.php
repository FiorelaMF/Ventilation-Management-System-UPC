...
<body>
    ...
    <li class="nav-item dropdown">
        ...
        <li><a class="dropdown-item" href="#" id="ver_asist">Ver asistencias</a></li>
    ...
    <?php
        include 'ventanas/verasistencias.php';
        include 'ventanas/verventilacion.php';
        echo "<script language=javascript> console.log('lineanum'); </script>";
    ?>

    <script type="text/JavaScript" src="../../js/controlador_alumno.js"></script>
    <?php 
    if($estado2==0 && $estado1==0){
        echo "<script language=javascript> $('#bienvenida').show(); ".
        "$('#ver_vent_alum').hide(); ".
        "$('#ver_asist_alum').hide(); </script>";
        //"$('#ver_vent_tabla').hide(); ".

    } else if($estado2==1){
        echo "<script language=javascript> $('#bienvenida').hide();".
        "$('#ver_asist_alum').hide();".
        "$('#ver_vent_alum').fadeIn(1000);". 
        " </script>";
    }  else if($estado1==1){
        echo "<script language=javascript> $('#bienvenida').hide();".
        "$('#ver_asist_alum').fadeIn(1000);".
        "$('#ver_vent_alum').show();". 
        " </script>";
    }
